...
private:
  ...
  void TermSort_SIMD(const void *base, void *MemoryIndex, size_t MemoryIndexLength) const;
  ...
  template <size_t N> void ExecuteTemplatedSort(const void* base, void* a, size_t n) const;
