...
The AutodetectFieldtypes is designed to detect a number of built-in datatypes\n\
including, \"box\", \"date\", \"date-range\", \"numerical\", \"numerical-range\" and encoded\n\
vector endbeddings \"hnsw\" (identifying hex, base64 and JSON array encodings)" ;
}
